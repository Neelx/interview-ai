          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="px-8 py-4 bg-white text-slate-700 font-medium rounded-xl shadow-md hover:shadow-lg border border-slate-200 transform hover:-translate-y-1 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 text-center">
                  Learn More
                </button>
              </div>
